export const CONTENT_RPC_MESSAGES = {
  ...
  // form fill actions
  FORM_ACTION_AUTHORIZE: 'BH_FORM_ACTION_AUTHORIZE',
...
export const SIDE_PANEL_MESSAGES = {
  ...
  FLOATING_PANEL_CLOSE: 'BH_SIDE_PANEL_FLOATING_PANEL_CLOSE',
  FLOATING_PANEL_OPEN_NATIVE: 'BH_SIDE_PANEL_FLOATING_PANEL_OPEN_NATIVE'
} as const;
