export const CONTENT_RPC_MESSAGES = {
  ...
  PAGE_HEALTH_ENABLE: 'BH_PAGE_HEALTH_ENABLE',
  ...
  STORAGE_SET: 'BH_STORAGE_SET',
  STORAGE_DELETE: 'BH_STORAGE_DELETE',
  STORAGE_CLEAR: 'BH_STORAGE_CLEAR',
  // form fill actions
...
export const RUNTIME_MESSAGES = {
  ...
  REQUEST_CAPABILITY: 'BH_RUNTIME_REQUEST_CAPABILITY',
  TEST_PROVIDER_CONNECTION: 'BH_RUNTIME_TEST_PROVIDER_CONNECTION',
  SET_DOMAIN_ADAPTER_ENABLED: 'BH_RUNTIME_SET_DOMAIN_ADAPTER_ENABLED',
...
export const OFFSCREEN_MESSAGES = {
  CLIPBOARD: 'BH_OFFSCREEN_CLIPBOARD'
} as const;
...
export type OffscreenMessageName =
  (typeof OFFSCREEN_MESSAGES)[keyof typeof OFFSCREEN_MESSAGES];
